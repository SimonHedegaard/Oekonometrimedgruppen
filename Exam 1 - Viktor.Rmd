...
We can see that if education increases by one unit, then salary increases by 2,3 pct. Furthermore, we can see that the estimate is significant down to a 0.1 pct. significance level. 

We can see from the model that salary increases the most when the beginning salary increases with 1% holding everything else fixed.
